...
public class GeminiManager : MonoBehaviour
{
    ...
    public string responseCSV = "";

    public string responseCSVObjects = "";
    ...
    public IEnumerator SendDataToGAS(string prompt, bool isCSVCalculationData)
    {
        ...
        if(www.result == UnityWebRequest.Result.Success)
        {
            ...
            if(isCSVCalculationData){
                responseCSV = response;
                responseCSVObjects = "";
            } else {
                responseCSVObjects = response;
                responseCSV = "";
            }
